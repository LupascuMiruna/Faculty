...
DezinfectantBacterii::~DezinfectantBacterii(){}
DezinfectantBacterii::DezinfectantBacterii(std::vector<std::string>suprafete, std::vector<std::string>ingrediente,int nr_organisme_ucise):
        Dezinfectant(suprafete, ingrediente,nr_organisme_ucise){}
DezinfectantBacterii::DezinfectantBacterii(const DezinfectantBacterii& obj):Dezinfectant(obj){}
...
std::istream &operator >>(std::istream &in, DezinfectantBacterii &obj)
{
    int i, n;
    std:: string x;
...
std::ostream& operator << (std::ostream &out, const DezinfectantBacterii &obj)
{
